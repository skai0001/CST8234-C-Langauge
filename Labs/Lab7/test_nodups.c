...
Suite * test_suite(void) {
	 ...
	 * 
	 **********************************************/
   	tcase_add_test(tc_llist, test_nodups_01 );
   	tcase_add_test(tc_llist, test_nodups_02 );
   	tcase_add_test(tc_llist, test_nodups_03 );
   	tcase_add_test(tc_llist, test_nodups_04 );
